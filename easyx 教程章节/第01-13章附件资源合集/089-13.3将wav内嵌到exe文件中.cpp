...
{	
	...
	_tcscat_s(tmpmp3, _T("055-7.3周杰伦 - 听妈妈的话.wav")); // 所加载的音频名称
	...
	HRSRC    hRes    = FindResource(NULL, _T("MYWAVE"), _T("WAVE"));  // 资源ID、类型名称
	...
	_stprintf_s(mcicmd, _T("open \"%s\" type MPEGVideo alias mymusic"), tmpmp3);
